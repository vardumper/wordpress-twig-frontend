<?php
/**
 * Google Shopping Variations Controller - prepares data and passes it to specific template
 *
 * @category Class
...
class GoogleShoppingVariationsController {
    /**
    * @var Request
    */
    protected $request;
    ...
    public function render() : Response
    {
        ...
        $this->response->setContent($this->template->render('google-shopping-variations.xml', $data));
        return $this->response;
    }
}